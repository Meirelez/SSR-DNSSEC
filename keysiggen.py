...
def create_dummy_signature():
    ...
    dummy_signature = os.urandom(64)  # Match the signature size for ECDSAP256SHA256
...
signer_name = "example.edu"  # Signer's zone
type_covered = "A"  # Record type being covered
algorithm = 13  # ECDSAP256SHA256 algorithm
